...
The image below explains the interrupt routing for legacy interrupts, i.e. interrupts that use the non-GIC interrupt handler, which is still present in Rasperry Pi 4.
