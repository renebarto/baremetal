...
| AUX_SPIn_IO_REG     | Base+0x20 | 31:16 | -                   |     | Reserved. Write 0, read don't care.
...
| AUX_SPIn_TXHOLD_REG | Base+0x30 | 31:24 | Byte count          |     | Number of bytes to send. This field is only valid when using 'variable shift' mode.<br/>Reset level: 0
|                     |           | 23:0  | Data                | R/W | Bytes to send (lowest byte first).<br/>Reset level: 0
