# Raspberry Pi UART0 {#RASPBERRY_PI_UART0}
...
|-----------------|-----------------|-------|---------------------------------------|-----|---------|
| AUX_MU_IO_REG   | Base+0x00215040 | 31:8  | -                                     | -   | Reserved (write 0, read X)
...
| AUX_MU_IER_REG  | Base+0x00215044 | 31:8  | -                                     | -   | Reserved (write 0, read X)
...
| AUX_MU_IIR_REG  | Base+0x00215048 | 31:8  | -                                     | -   | Reserved (write 0, read X)
...
| AUX_MU_LCR_REG  | Base+0x0021504C | 31:8  | -                                     | -   | Reserved (write 0, read X)
