...
## Extending the timer {#TUTORIAL_28_I2S_EXTENDING_THE_TIMER}

## Adding interrupts to the timer - Step 1 {#TUTORIAL_28_I2S_ADDING_INTERRUPTS_TO_THE_TIMER___STEP_1}

We'll add some functionality to the `Timer` class for enabling, handling and disabling interrupts on the timer.

### Timer.h {#TUTORIAL_28_I2S_ADDING_INTERRUPTS_TO_THE_TIMER___STEP_1_TIMERH}
