# Tutorial 29: Multi-core {#TUTORIAL_29_MULTI_CORE}

@tableofcontents

## Tutorial setup {#TUTORIAL_29_MULTI_CORE_TUTORIAL_SETUP}
...
### Tutorial results {#TUTORIAL_29_MULTI_CORE_TUTORIAL_SETUP_TUTORIAL_RESULTS}
...
## Extending the timer {#TUTORIAL_29_MULTI_CORE_EXTENDING_THE_TIMER}

## Adding interrupts to the timer - Step 1 {#TUTORIAL_29_MULTI_CORE_ADDING_INTERRUPTS_TO_THE_TIMER___STEP_1}

We'll add some functionality to the `Timer` class for enabling, handling and disabling interrupts on the timer.

### Timer.h {#TUTORIAL_29_MULTI_CORE_ADDING_INTERRUPTS_TO_THE_TIMER___STEP_1_TIMERH}
