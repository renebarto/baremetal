# Tutorial 30: DMA {#TUTORIAL_30_DMA}

@tableofcontents

## Tutorial setup {#TUTORIAL_30_DMA_TUTORIAL_SETUP}
...
### Tutorial results {#TUTORIAL_30_DMA_TUTORIAL_SETUP_TUTORIAL_RESULTS}
...
## Extending the timer {#TUTORIAL_30_DMA_EXTENDING_THE_TIMER}

## Adding interrupts to the timer - Step 1 {#TUTORIAL_30_DMA_ADDING_INTERRUPTS_TO_THE_TIMER___STEP_1}

We'll add some functionality to the `Timer` class for enabling, handling and disabling interrupts on the timer.

### Timer.h {#TUTORIAL_30_DMA_ADDING_INTERRUPTS_TO_THE_TIMER___STEP_1_TIMERH}
