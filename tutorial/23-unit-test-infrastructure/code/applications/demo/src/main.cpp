...
class FixtureMyTest1Helper : public FixtureMyTest1
{
public:
...
TestRegistrar registrarFixtureMyTest1(TestRegistry::GetTestRegistry(), &myTest1,
                                      TestDetails("MyTest1", "FixtureMyTest1", GetSuiteName(), __FILE__, __LINE__));
...
class FixtureMyTest2Helper : public FixtureMyTest2
{
public:
...
class MyTest2 : public Test
{
    void RunImpl() const override;
} myTest1;

TestRegistrar registrarFixtureMyTest2(TestRegistry::GetTestRegistry(), &myTest1,
                                      TestDetails("MyTest2", "FixtureMyTest2", GetSuiteName(), __FILE__, __LINE__));
...
class FixtureMyTest3Helper : public FixtureMyTest3
{
public:
...
class MyTest3 : public Test
{
    void RunImpl() const override;
} myTest3;

TestRegistrar registrarFixtureMyTest3(TestRegistry::GetTestRegistry(), &myTest3,
                                      TestDetails("MyTest3", "FixtureMyTest3", GetSuiteName(), __FILE__, __LINE__));
...
void MyTest::RunImpl() const
{
    ...
    CurrentTest::Results()->OnTestFailure(*CurrentTest::Details(), "Failure message example");
}
